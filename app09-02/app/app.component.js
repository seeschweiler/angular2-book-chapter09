            ...
            AppComponent = (function () {
                ...
                AppComponent.prototype.getBookmarks = function () {
                    ...
                    this._bookmarkService.getBookmarks()
                        .then(function (bookmarks) { return _this.bookmarks = bookmarks; }, function (error) { return _this.errorMessage = error; });
                };
                AppComponent.prototype.addBookmark = function (title, url) {
                    ...
                    this._bookmarkService.addBookmark(title, url)
                        .then(function (bookmark) { return _this.bookmarks.push(bookmark); }, function (error) { return _this.errorMessage = error; });
                };
